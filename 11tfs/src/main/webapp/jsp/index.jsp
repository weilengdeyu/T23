        ...
        <div class="layui-layout layui-layout-admin">
            <div class="layui-header header header-demo">
                <div class="layui-main">
                   ...
                   <img src="${pageContext.request.contextPath}/images/logo.png" width="200" height="100"></img>
                    </a>
                    ...
                    <!--数据管理-->
                        <li class="layui-nav-item">
                            <a class="javascript:;" href="javascript:;" _href="main.html">
                               <i class="layui-icon" style="top: 3px;">&#xe62d;</i><cite>学员管理</cite>
                            </a>
                      <dl class="layui-nav-child">
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="/tfs/findAll">
                                           <cite>新增反馈</cite>
                                        </a>
                              </dd>
                                </dd>
                                ...
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="${pageContext.request.contextPath}/jsp/shujutongji.jsp">
                                            <cite>学员Offer</cite>
                                        </a>
                                    </dd>
                                </dd>
                      ...
                      <!--  <li class="layui-nav-item">
                            <a class="javascript:;" href="javascript:;" _href="User_management.html">
                                <i class="layui-icon" style="top: 3px;">&#xe613;</i><cite>学员使用</cite>
                            </a>
                        </li>
                        &lt;!&ndash;角色管理&ndash;&gt;
                        <li class="layui-nav-item">
            ...
            <div class="layui-tab layui-tab-card site-demo-title x-main" lay-filter="x-tab" lay-allowclose="true">
                ...
                <div class="layui-tab-content site-demo site-demo-body">
                    <div class="layui-tab-item layui-show">
                        <iframe frameborder="0" src="${pageContext.request.contextPath}/jsp/main.html" class="x-iframe"></iframe>
                    </div>
                </div>
            </div>
